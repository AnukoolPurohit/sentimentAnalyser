...
from ..utils.preprocessing import default_pre_rules, default_post_rules, default_spec_tok
from ..utils.data import compose, parallel
from ..utils.processor import uniquefy


class TokenizerProcessor:
    """
     Class for converting a text into Tokens using spacy tokenizer.
    """
    ...
    def deproc1(self, toks):
        """De-process a single item"""
        return ' '.join(toks)
    
    def deprocess(self, docs):
        """De-process multiple items"""
